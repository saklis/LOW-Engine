...
int32_t LowEngine::Assets::LoadTexture(const std::string& path) {
    try {
...
int32_t LowEngine::Assets::LoadTexture(const std::string& path, const std::string& alias) {
...
sf::Texture& LowEngine::Assets::GetDefaultTexture() {
    return GetInstance()->_textures[0];
}

sf::Texture& LowEngine::Assets::GetTexture(int32_t textureId) {
...
sf::Texture& LowEngine::Assets::GetTexture(const std::string& textureAlias) {
...
void LowEngine::Assets::UnloadAll() {
